    ...
    return (
        <div className='mt-0 lg:mt-4'>            
             ...
             <ul className='grid grid-cols-2 md:grid-cols-5  mx-auto [&>*:first-child]:col-span-2  [&>*:first-child]:row-span-2 gap-1 lg:gap-5 '> 
                   ...
                   {
                     IMGs.map((IMG)=> <li draggable key={IMG.id} className="border-2 border-gray-300 rounded-md  lg:w-full"><Card IMG = {IMG} handleChange={handleChange}></Card></li>) 
                   }
